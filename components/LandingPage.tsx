  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <section className="relative min-h-[95vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-purple-600/10 blur-[150px] rounded-full pointer-events-none"></div>
      ...
      <section className="py-24 px-6 bg-zinc-950/50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
             <div className="aspect-video glass-effect rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
               <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=800" alt="Platform UI Preview" className="w-full h-full object-cover opacity-60" />
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto glass-effect p-12 md:p-20 rounded-[3rem] text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-black mb-6">Ready For<br/><span className="gradient-text">AI Transpormation?</span></h2>
            <p className="text-gray-400 text-lg mb-12 max-w-xl mx-auto">Turn Generative AI into your most powerful daily asset.</p>
            <button onClick={() => setView('diagnosis')} className="mx-auto px-10 py-5 gradient-bg rounded-2xl font-black text-lg hover:scale-105 transition-all flex items-center justify-center gap-2 shadow-2xl shadow-purple-500/20">
